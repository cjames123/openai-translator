...
def translate(upload_file, source_language, target_language,
              file_format, model_version):

    model_api_key = os.getenv("OPENAI_API_KEY")
    model = OpenAIModel(model=model_version, api_key=model_api_key)
...
def launch_gradio():
    ...
    iface = gr.Interface(
        ...
        inputs=[
            ...
            gr.Radio(label="模型", choices=["gpt-3.5-turbo", "chatGLM3"], value="gpt-3.5-turbo")
        ],
        outputs=[
